  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-none text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient: "gradient-primary text-primary-foreground hover:shadow-glow-lg hover:scale-[1.02] active:scale-[0.98]",
        glass: "glass hover:bg-[hsl(var(--glass-bg))] hover:shadow-soft-lg",
      },
      size: {
        default: "h-11 px-6 py-2",
        sm: "h-9 rounded-none px-4",
        lg: "h-14 rounded-none px-8 text-base",
        xl: "h-16 rounded-none px-10 text-lg",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
