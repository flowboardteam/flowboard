    ...
    <aside className="w-full h-full bg-[var(--sidebar-bg)] border-r border-[var(--border-color)] flex flex-col p-6 overflow-y-auto no-scrollbar relative">
                    ...
                    {item.items?.map(sub => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {badge !== null && (
                            <span className={`text-[10px] font-black px-2 py-0.5 rounded-full min-w-[20px] text-center shrink-0 ${badgeColor}`}>
                              {badge}
                            </span>
                          )}
                        </NavLink>
      ...
      <div className="mt-10 pt-6 border-t border-[var(--border-color)] relative">
        ...
        <button
          ...
          className="w-full flex items-center justify-between p-2 rounded-2xl hover:bg-slate-500/5 transition-all"
        >
