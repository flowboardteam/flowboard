        ...
        <div className="flex items-center justify-between py-4 lg:py-5">
          ...
          <div className="flex items-center gap-6">
            <a href="/" className="flex items-center gap-2">
              ...
              {/* FIXED: Text hidden on mobile, visible on large screens */}
            ...
            <div className="hidden lg:flex items-center gap-6">
              {[
                ...
                <a
                  ...
                  className={`relative text-sm font-medium ${textColor} transition-colors after:absolute after:left-0 after:bottom-0 after:w-0 after:h-[2px]
          ...
          <div className="hidden lg:flex items-center gap-4 relative">
            ...
            {/* Profile */}
            <button className={`p-2 rounded-full ${hoverBg} transition`}>
              <User className={`w-5 h-5 ${iconColor}`} />
            </button>

            {/* CTA - UPDATED TO SQUARE */}
            <Button
              size="sm"
              className={`px-6 py-2 font-semibold rounded-sm ${
                isOverHero
          ...
          <div className="bg-white rounded-xl shadow-lg p-4 mb-4 space-y-4">
            {[
              ...
              <a
                key={label}
                href="#"
                className="block text-slate-800 font-medium py-1"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                {label}
              </a>
            ))}
            {/* MOBILE CTA - UPDATED TO SQUARE */}
