  ...
  return (
    <section className="py-24 relative overflow-hidden bg-gray-50 text-gray-900">
      ...
      <div className="absolute inset-0 overflow-hidden opacity-20 pointer-events-none">
        <div className="absolute top-[-10rem] left-[-10rem] w-[500px] h-[500px] rounded-none bg-gradient-to-r from-purple-200 via-pink-200 to-yellow-200 animate-blob" />
        <div className="absolute bottom-[-8rem] right-[-8rem] w-[400px] h-[400px] rounded-none bg-gradient-to-r from-cyan-200 via-blue-200 to-purple-200 animate-blob animation-delay-2000" />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            className="relative rounded-none p-px overflow-hidden shadow-lg"
          >
            {/* Glowing Border */}
            <div className="absolute inset-0 rounded-none bg-gradient-to-r from-purple-300 via-pink-300 to-yellow-300 opacity-30 blur-xl" />

            {/* Inner Content */}
            <div className="relative bg-white rounded-none p-8 md:p-12 lg:p-16 text-center border border-gray-200">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 bg-purple-100 rounded-none px-5 py-2 mb-8 border border-purple-200">
