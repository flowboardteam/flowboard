      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-end md:items-stretch md:justify-end">
          ...
          <motion.div 
            ...
            className="relative w-full md:max-w-xl bg-[var(--card-bg)] border-t md:border-t-0 md:border-l border-[var(--border-color)] h-[90vh] md:h-full rounded-2xl md:rounded-none p-6 md:p-10 overflow-y-auto"
          >
            {/* Mobile Drag Handle */}
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="p-4 rounded-xl border border-[var(--border-color)] bg-white/5">
              ...
              <div className="pt-6 border-t border-[var(--border-color)] mt-auto">
                 ...
                 {/* onClick={onDeploy} handles the Handshake Terminal trigger */}
                  <button 
                   onClick={onDeploy}
                   className="group w-full bg-blue-600 hover:bg-blue-500 text-white py-5 rounded-xl font-black uppercase tracking-[0.2em] text-xs flex items-center justify-center gap-3 active:scale-95 transition-all shadow-xl shadow-blue-600/20"
                  >
