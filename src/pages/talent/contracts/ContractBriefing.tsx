            ...
            <div className="space-y-8">
              ...
              <div className="pt-6 border-t border-[var(--border-color)] mt-auto">
                 ...
                 {/* onClick={onDeploy} handles the Handshake Terminal trigger */}
                  <button 
                   onClick={onDeploy}
                   className="group w-full bg-blue-600 hover:bg-blue-500 text-white py-5 rounded-xl font-black tracking-[0.2em] text-xs flex items-center justify-center gap-3 active:scale-95 transition-all shadow-xl shadow-blue-600/20"
                  >
