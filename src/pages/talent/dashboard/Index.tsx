      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 p-8 rounded-[2.5rem] bg-[#050B1E] text-white shadow-xl relative overflow-hidden group border border-white/5">
          ...
          <div className="relative z-10">
            ...
            <button className="mt-6 px-8 py-3 bg-blue-600 text-white font-black text-xs uppercase italic tracking-widest rounded-xl hover:bg-blue-500 transition-all hover:scale-105 active:scale-95 shadow-lg shadow-blue-600/40">
              Browse Contracts
            </button>
          </div>
        </div>
