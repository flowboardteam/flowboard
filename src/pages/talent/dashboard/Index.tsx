  ...
  return (
    <div className="max-w-6xl mx-auto space-y-10 pb-20">
      ...
      <div className="max-w-3xl mx-auto relative group">
        <div className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#A079FF] transition-colors">
          <Search className="w-5 h-5" />
        </div>
        <input 
          type="text"
          placeholder="Search for people, pages, apps or ask Talent AI"
          className="w-full h-16 pl-16 pr-20 bg-white border border-[#EEEEF0] rounded-2xl shadow-sm text-sm font-medium outline-none focus:border-[#A079FF] transition-all"
        />
      ...
      {(activeTab === "All" || activeTab === "Teams") && (
        <div className="relative h-[240px] rounded-2xl bg-[#A079FF]/10 overflow-hidden flex items-center group shadow-sm border border-[#A079FF]/30">
          <div className="relative z-10 pl-12 md:pl-20 max-w-xl space-y-4">
            ...
            <button className="px-6 py-3 bg-white border border-[#A079FF]/40 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-[#A079FF]/10 transition-all shadow-sm">
              Learn more
            </button>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white border border-[#EEEEF0] rounded-2xl p-8 shadow-sm space-y-8">
          <div className="flex items-center justify-between">
            <h3 className="flex items-center gap-2 text-sm font-black text-[#1A1C21] uppercase tracking-widest">
              <Wallet className="w-4 h-4 text-[#A079FF]" /> Payments tracker
            </h3>
            <button className="text-xs font-black text-slate-400 hover:text-[#A079FF] uppercase tracking-widest">
              View all
            </button>
          </div>
        ...
        <div className="bg-white border border-[#EEEEF0] rounded-2xl p-8 shadow-sm space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Link to="/talent/contracts" className="p-6 bg-slate-50 hover:bg-[#A079FF]/5 border border-[#EEEEF0] hover:border-[#A079FF]/30 rounded-2xl space-y-4 transition-all group cursor-pointer block">
              <div className="flex justify-between items-start">
                <span className="text-[10px] font-black text-slate-500 group-hover:text-[#A079FF] uppercase tracking-widest">Active Contracts</span>
                <Layers className="w-3.5 h-3.5 text-slate-400 group-hover:text-[#A079FF]" />
              </div>
              <div>
                <span className="text-2xl font-black text-[#1A1C21]">0</span>
                <p className="text-[10px] font-bold text-slate-400 mt-1">Ongoing engagements</p>
              </div>
            </Link>
            ...
            <Link to="/talent/project" className="p-6 bg-slate-50 hover:bg-[#A079FF]/5 border border-[#EEEEF0] hover:border-[#A079FF]/30 rounded-2xl space-y-4 transition-all group cursor-pointer block">
              ...
              <div>
                <span className="text-2xl font-black text-[#1A1C21]">0</span>
                <p className="text-[10px] font-bold text-slate-400 mt-1">Active projects</p>
              </div>
            </Link>

            <Link to="/talent/contract-changes" className="p-6 bg-slate-50 hover:bg-[#A079FF]/5 border border-[#EEEEF0] hover:border-[#A079FF]/30 rounded-2xl space-y-4 transition-all group cursor-pointer block">
              <div className="flex justify-between items-start">
                <span className="text-[10px] font-black text-slate-500 group-hover:text-[#A079FF] uppercase tracking-widest">Contract Changes</span>
                <ArrowRightLeft className="w-3.5 h-3.5 text-slate-400 group-hover:text-[#A079FF]" />
              </div>
              <div>
                <span className="text-2xl font-black text-[#1A1C21]">0</span>
                <p className="text-[10px] font-bold text-slate-400 mt-1">Pending requests</p>
              </div>
            </Link>
          </div>
        </div>
        ...
        <div className="bg-white border border-[#EEEEF0] rounded-2xl p-8 shadow-sm space-y-6">
          <div className="flex items-center justify-between">
            <h3 className="flex items-center gap-2 text-sm font-black text-[#1A1C21] uppercase tracking-widest">
              <CheckSquare className="w-4 h-4 text-[#A079FF]" /> For you today
            </h3>
            <div className="flex items-center gap-2">
          ...
          <div className="space-y-4">
             {/* Security Nudge */}
             <div className="p-5 bg-white border border-[#EEEEF0] rounded-2xl flex items-center gap-4 group hover:border-[#A079FF]/30 transition-all cursor-pointer">
