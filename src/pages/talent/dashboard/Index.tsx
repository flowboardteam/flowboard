  ...
  return (
    <div className="max-w-6xl mx-auto space-y-10 pb-20">
      ...
      <div className="max-w-2xl mx-auto relative group">
        ...
        />
        <div className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-1 px-1.5 py-0.5 bg-slate-100 rounded text-[9px] font-bold text-slate-400">
          <span>⌘</span>
          <span>K</span>
        </div>
      </div>
      ...
      {(activeTab === "All" || activeTab === "Teams") && (
        <div className="relative h-[200px] rounded-2xl bg-[#A079FF]/10 overflow-hidden flex items-center group shadow-sm border border-[#A079FF]/30">
          <div className="relative z-10 pl-8 md:pl-12 max-w-lg space-y-2.5">
            ...
            <button className="px-4 py-2 bg-white border border-[#A079FF]/40 rounded-lg text-xs font-bold hover:bg-[#A079FF]/10 transition-all shadow-sm">
              Learn more
            </button>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-[#EEEEF0] rounded-2xl p-5 shadow-sm space-y-5">
          <div className="flex items-center justify-between">
            <h3 className="flex items-center gap-2 text-xs font-bold text-[#1A1C21] uppercase tracking-wider">
              <Wallet className="w-3.5 h-3.5 text-[#A079FF]" /> Payments tracker
            </h3>
            <button className="text-[11px] font-bold text-slate-400 hover:text-[#A079FF] uppercase tracking-wider">
              View all
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="p-4 bg-slate-50 border border-[#EEEEF0] rounded-xl space-y-2.5">
              <div className="flex justify-between items-start">
                <span className="text-[9px] font-bold text-slate-500 uppercase tracking-wider">Unpaid invoices</span>
                <FileText className="w-3.5 h-3.5 text-slate-400" />
              </div>
              <div>
                <span className="text-xl font-black text-[#1A1C21]">$0</span>
                <p className="text-[9px] font-medium text-slate-400 mt-0.5">USD • 0 invoices</p>
              </div>
            </div>

            <div className="p-4 bg-slate-50 border border-[#EEEEF0] rounded-xl space-y-2.5">
              <div className="flex justify-between items-start">
                <span className="text-[9px] font-bold text-slate-500 uppercase tracking-wider">Processing payments</span>
                <CreditCard className="w-3.5 h-3.5 text-slate-400" />
              </div>
              <div>
                <span className="text-xl font-black text-[#1A1C21]">$0</span>
                <p className="text-[9px] font-medium text-slate-400 mt-0.5">USD • 0 payments</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white border border-[#EEEEF0] rounded-2xl p-5 shadow-sm space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Link to="/talent/contracts" className="p-4 bg-slate-50 hover:bg-[#A079FF]/5 border border-[#EEEEF0] hover:border-[#A079FF]/30 rounded-xl space-y-2.5 transition-all group cursor-pointer block">
              <div className="flex justify-between items-start">
                <span className="text-[9px] font-bold text-slate-500 group-hover:text-[#A079FF] uppercase tracking-wider">Active Contracts</span>
                <Layers className="w-3.5 h-3.5 text-slate-400 group-hover:text-[#A079FF]" />
              </div>
              <div>
                <span className="text-xl font-black text-[#1A1C21]">0</span>
                <p className="text-[9px] font-medium text-slate-400 mt-0.5">Ongoing engagements</p>
              </div>
            </Link>
            ...
            <Link to="/talent/project" className="p-4 bg-slate-50 hover:bg-[#A079FF]/5 border border-[#EEEEF0] hover:border-[#A079FF]/30 rounded-xl space-y-2.5 transition-all group cursor-pointer block">
              <div className="flex justify-between items-start">
                <span className="text-[9px] font-bold text-slate-500 group-hover:text-[#A079FF] uppercase tracking-wider">Projects</span>
                <FolderKanban className="w-3.5 h-3.5 text-slate-400 group-hover:text-[#A079FF]" />
              </div>
              <div>
                <span className="text-xl font-black text-[#1A1C21]">0</span>
                <p className="text-[9px] font-medium text-slate-400 mt-0.5">Active projects</p>
              </div>
            </Link>
            ...
            <Link to="/talent/contract-changes" className="p-4 bg-slate-50 hover:bg-[#A079FF]/5 border border-[#EEEEF0] hover:border-[#A079FF]/30 rounded-xl space-y-2.5 transition-all group cursor-pointer block">
              <div className="flex justify-between items-start">
                <span className="text-[9px] font-bold text-slate-500 group-hover:text-[#A079FF] uppercase tracking-wider">Contract Changes</span>
                <ArrowRightLeft className="w-3.5 h-3.5 text-slate-400 group-hover:text-[#A079FF]" />
              </div>
              <div>
                <span className="text-xl font-black text-[#1A1C21]">0</span>
                <p className="text-[9px] font-medium text-slate-400 mt-0.5">Pending requests</p>
              </div>
            </Link>
          </div>
        </div>
        ...
        <div className="bg-white border border-[#EEEEF0] rounded-2xl p-5 shadow-sm space-y-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5">
              <span className="px-2 py-0.5 bg-slate-100 rounded text-[9px] font-bold text-slate-500 uppercase">Manage</span>
              <X className="w-3.5 h-3.5 text-slate-300 cursor-pointer hover:text-slate-500" />
            </div>
          </div>

          <p className="text-[9px] font-bold text-slate-400 uppercase tracking-wider">To-dos that require your attention</p>
          ...
          <div className="space-y-3">
             ...
             <div className="p-3.5 bg-white border border-[#EEEEF0] rounded-xl flex items-center gap-3 group hover:border-[#A079FF]/30 transition-all cursor-pointer">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-bold text-[#1A1C21]">Boost your account security</p>
             ...
             <div className="p-4 bg-slate-50 border border-[#EEEEF0] rounded-xl space-y-3">
                <div className="flex items-center justify-between">
                  <p className="text-xs font-bold text-[#1A1C21]">Complete your onboarding</p>
                </div>
                  ...
                  <div className="p-3 bg-white border border-[#EEEEF0] rounded-lg flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                       <div className="flex justify-between items-center mb-1.5">
                         <p className="text-xs font-bold text-[#1A1C21]">Set up basics</p>
                         <span className="text-[9px] font-bold text-slate-400">33%</span>
                       </div>
                       <div className="w-full h-1 bg-slate-100 rounded-full overflow-hidden">
                         <div className="w-1/3 h-full bg-[#A079FF]" />
                       </div>
                       <p className="text-[9px] font-medium text-slate-400 mt-1.5">Next: <span className="text-slate-600">Set up your entities</span></p>
                    </div>
                    <button className="px-3 py-1.5 bg-[#1A1C21] text-white text-[9px] font-bold uppercase tracking-wider rounded hover:bg-black transition-all">
                      Continue
                    </button>
                  </div>
                </div>
