    ...
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-8 pb-32 bg-[var(--background)] dark:bg-[#020617] min-h-screen transition-colors duration-300">
      ...
      <header className="bg-[var(--card-bg)] border border-[var(--border-color)] rounded-[2rem] p-5 md:p-10 flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-10 shadow-sm text-center md:text-left overflow-hidden">
        ...
        <div className="flex-1 space-y-5 w-full min-w-0">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-3 w-full">
            ...
            <span className="inline-flex items-center px-4 py-2 bg-slate-500/10 text-slate-600 dark:text-slate-300 border border-transparent rounded-xl text-[10px] md:text-[11px] font-black uppercase tracking-widest whitespace-nowrap">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 space-y-8">
          ...
          <section className=" dark:bg-[#0B1120] dark:bg-[#0B1120] bg-[var(--card-bg)] border border-[var(--border-color)] rounded-[2rem] p-8 space-y-8 shadow-sm">
            <div className="space-y-4">
              ...
              <textarea
                ...
                className="w-full bg-slate-500/5 dark:bg-slate-900/50 border border-[var(--border-color)] rounded-2xl p-5 text-base outline-none focus:border-[#00A86B] focus:ring-4 focus:ring-emerald-500/5 transition-all text-[var(--foreground)]"
              />
            </div>
          ...
          <section className="bg-[var(--card-bg)] border border-[var(--border-color)] rounded-[2rem] p-8 space-y-10 shadow-sm">
            {/* Skills Stack */}
          ...
          {/* LANGUAGES SECTION */}
          <section className="bg-[var(--card-bg)] border border-[var(--border-color)] rounded-[2rem] p-8 space-y-6 shadow-sm">
            <h3 className="flex items-center gap-2 text-[11px] font-black uppercase tracking-widest text-slate-400">
