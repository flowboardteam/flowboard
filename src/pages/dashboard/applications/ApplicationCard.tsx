...
export function ApplicationCard({ app }: ApplicationCardProps) {
  return (
    <div className="group bg-white p-6 rounded-[2rem] border border-slate-200 hover:border-blue-500/30 hover:shadow-xl hover:shadow-blue-500/5 transition-all cursor-pointer">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        
        {/* Job Info */}
        <div className="flex items-center gap-5">
          <div className="w-14 h-14 bg-[#050B1E] rounded-2xl flex items-center justify-center text-white font-black text-lg group-hover:bg-blue-600 transition-colors">
            {app.companyLogo}
          </div>
          <div>
        ...
        <div className="flex items-center justify-between lg:justify-end gap-4 lg:gap-12 border-t lg:border-none pt-4 lg:pt-0">
          ...
          <button className="flex items-center justify-center w-10 h-10 rounded-full bg-slate-50 text-slate-400 group-hover:bg-blue-600 group-hover:text-white transition-all shadow-sm">
