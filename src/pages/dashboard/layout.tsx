        ...
        <div className="flex-1 flex flex-col min-w-0 relative">
          ...
          <header className="h-20 flex items-center justify-between px-6 md:px-10 shrink-0 border-b border-slate-100 bg-white/40 backdrop-blur-md">
            ...
            <div className="flex items-center gap-3 md:gap-6">
              <div className="hidden md:flex items-center bg-white border border-slate-200 rounded-none px-4 py-2 w-64 shadow-sm">
                <Search className="w-4 h-4 text-slate-400" />
                <input type="text" placeholder="Search..." className="bg-transparent border-none text-sm ml-2 outline-none w-full" />
              </div>
              <div className="flex items-center gap-2 md:gap-3">
                <button className="relative p-2.5 bg-white border border-slate-200 rounded-none text-slate-500 shadow-sm">
                  <Bell className="w-5 h-5" />
                  <span className="absolute top-2.5 right-2.5 w-2 h-2 bg-red-500 rounded-none border-2 border-white"></span>
                </button>
                <div className="w-10 h-10 rounded-none bg-blue-600 flex items-center justify-center text-white font-bold text-sm shadow-lg shadow-blue-600/20">
