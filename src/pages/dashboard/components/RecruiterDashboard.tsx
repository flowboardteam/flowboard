  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex items-center justify-between">
        ...
        <Button className="bg-blue-600 hover:bg-blue-700 h-12 rounded-none gap-2 px-6">
      ...
      <div className="h-64 border-2 border-dashed border-slate-200 rounded-none flex flex-col items-center justify-center text-slate-400">
