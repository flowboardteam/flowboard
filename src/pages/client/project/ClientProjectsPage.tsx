  ...
  return(
    <motion.div layout initial={{opacity:0,y:12}} animate={{opacity:1,y:0}} exit={{opacity:0,scale:0.97}}
      ...
      <div className="flex items-center gap-2 flex-wrap pr-8">
        <span className={`inline-flex items-center text-[10px] font-black uppercase px-2.5 py-1 rounded-lg border ${sc.bg} ${sc.color}`}>{sc.label}</span>
            ...
            <AnimatePresence>
              {filtered.map(p=>viewMode==="grid"?(
                ...
                <motion.div key={p.id} layout initial={{opacity:0,y:8}} animate={{opacity:1,y:0}} exit={{opacity:0,scale:0.97}}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1"><h3 className="text-sm font-black dark:text-white truncate">{p.name}</h3></div>
