    ...
    <div className="max-w-6xl mx-auto space-y-8 pb-20">
        ...
        <div className="space-y-2">
          ...
          {sourceRole && (
            <div className="flex items-center gap-2 mt-1">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest bg-emerald-500/10 text-emerald-600 border border-emerald-500/20 px-2.5 py-1 rounded-full">
                {sourceRole.title}
              </span>
            </div>
          )}
      ...
      <div className="p-8 rounded-[2.5rem] bg-[var(--card-bg)] border border-[var(--border-color)] shadow-sm">
        ...
        <textarea
          ...
          className="w-full h-32 bg-slate-500/5 rounded-2xl p-6 text-lg font-medium outline-none focus:ring-2 ring-blue-500/20 transition-all border border-[var(--border-color)] resize-none"
        />
      ...
      <AnimatePresence mode="wait">
        ...
        {phase === "result" && spec && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
            <div className="px-6 py-4 rounded-2xl bg-blue-500/5 border border-blue-500/10 flex items-center justify-between">
            ...
            {candidates.length > 0 ? (
                ...
                <AnimatePresence>
                  {candidates.map(person => (
                    <motion.div
                      ...
                      key={person.login}
                      className="p-8 rounded-[2.5rem] bg-[var(--card-bg)] border border-[var(--border-color)] shadow-sm flex flex-col justify-between group hover:border-blue-500/50 transition-all relative"
                    >
                      <button
                      ...
                      <div>
                        <div className="flex justify-between items-start mb-6">
                          <img src={person.avatar_url} className="w-16 h-16 rounded-2xl border border-[var(--border-color)] object-cover shadow-sm" alt="" />
                          <div className="bg-blue-500/10 text-blue-500 px-3 py-1 rounded-full text-center mr-10">
                        ...
                        <div className="flex items-center gap-2 mb-4">
                          <span className="text-[10px] font-black bg-blue-500/10 text-blue-500 px-2 py-0.5 rounded uppercase">{person.seniorityLabel}</span>
              ...
              <div className="py-20 text-center space-y-4 bg-slate-500/5 rounded-[2.5rem] border border-dashed border-[var(--border-color)]">
