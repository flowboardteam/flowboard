      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-end md:items-stretch md:justify-end">
          ...
          <motion.div 
            ...
            className="relative w-full md:max-w-xl bg-[var(--card-bg)] border-t md:border-t-0 md:border-l border-[var(--border-color)] h-[90vh] md:h-full rounded-t-[2.5rem] md:rounded-t-none p-6 md:p-10 overflow-y-auto"
          >
            {/* Mobile Drag Handle */}
            ...
            <div className="flex justify-between items-start mb-8">
              ...
              <button onClick={onClose} className="p-2 bg-slate-800/50 rounded-full text-slate-400 hover:text-white transition-colors">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="space-y-8">
              <div className="flex flex-col gap-4">
                <div className="w-16 h-16 rounded-2xl bg-white/5 border border-[var(--border-color)] p-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="p-4 rounded-2xl border border-[var(--border-color)] bg-white/5">
              ...
              <div className="pt-6 border-t border-[var(--border-color)] mt-auto">
                 <div className="flex items-start gap-3 p-4 bg-blue-500/5 border border-blue-500/10 rounded-xl mb-6">
                 ...
                 <button 
                  onClick={onDeploy}
                  className="group w-full bg-blue-600 hover:bg-blue-500 text-white py-5 rounded-2xl font-black italic uppercase tracking-[0.2em] text-xs flex items-center justify-center gap-3 active:scale-95 transition-all shadow-xl shadow-blue-600/20"
                 >
