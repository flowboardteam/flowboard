    ...
    <div className="max-w-7xl mx-auto space-y-8 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1">
          <div className="flex items-center gap-2 text-[#A079FF] text-[11px] font-medium tracking-wider">
        ...
        <button
          ...
          className="w-full md:w-auto px-6 py-3 bg-[#A079FF] text-white font-medium text-xs tracking-wider rounded-lg hover:bg-[#A079FF]/90 transition-all shadow-md shadow-[#A079FF]/20 flex items-center justify-center gap-2"
        >
