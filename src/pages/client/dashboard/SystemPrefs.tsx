...
export default function SystemPrefs() {
  ...
  if (!mounted || isLoading) return (
    <div className="flex items-center justify-center h-64">
      <Loader2 className="w-8 h-8 animate-spin text-[#00A86B] rounded-full" />
    </div>
  );
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <button
            ...
            disabled={isSaving}
            className={`
              w-full py-5 rounded-xl flex items-center justify-center gap-3 transition-all transform active:scale-95 shadow-lg
          ...
          <AnimatePresence>
            {showSuccess && (
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="flex items-center gap-3 p-4 bg-[#00A86B]/10 border border-[#00A86B]/20 rounded-xl">
