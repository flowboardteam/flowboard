    ...
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-8 pb-32 bg-[var(--background)] dark:bg-[#020617] min-h-screen transition-colors duration-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 space-y-8">
          {/* COMPANY OVERVIEW */}
          <section className="bg-[var(--card-bg)] border border-[var(--border-color)] rounded-2xl p-8 space-y-8 shadow-sm">
            <div className="space-y-4">
              <h3 className="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-[var(--foreground)]">
          ...
          {/* COMPANY DETAILS */}
          <section className="bg-[var(--card-bg)] border border-[var(--border-color)] rounded-2xl p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 shadow-sm">
